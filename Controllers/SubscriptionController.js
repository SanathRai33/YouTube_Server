...
export const getUserSubscriptions = async (req, res) => {
  ...
  const subscriptions = await Subscription.find({ subscriber: userId }).populate("channel", "name channelname image");
...
export const getUserSubscribers = async (req, res) => {
  ...
  const subscribers = await Subscription.find({ channel: userId }).populate("subscriber", "name channelname image");
